...
import { LoginBackground, LoginForm, useGetMeQuery } from '@/features/auth'
import { ROUTES } from '@/shared/config'
import { Spinner, ThemeToggle } from '@/shared/ui'
...
const LoginPage = () => {
  ...
  return (
    <div
      ...
      style={{
        background: 'linear-gradient(155deg,#0E3826 0%,#1A6B3F 60%,#0A2A1B 100%)',
      }}
    >
      <LoginBackground />
