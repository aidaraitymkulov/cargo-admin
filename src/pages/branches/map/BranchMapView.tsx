...
import { useUpdateBranchMutation } from '@/api/admin/branches'
...
} from '@/types/entities/branches'
import { BranchMapSidebar } from './BranchMapSidebar'
import { createBranchMarkerIcon } from './branchMarkerIcon'
import { DEFAULT_BRANCH_LAT, DEFAULT_BRANCH_LNG, DEFAULT_MAP_CENTER } from './constants'
...
export const BranchMapView = ({ branches, focusId, onBack }: Props) => {
  ...
  const handleSave = form.handleSubmit(async (values) => {
    ...
    try {
      const updated = await updateBranch({ id: selectedBranch.id, data: formData }).unwrap()
