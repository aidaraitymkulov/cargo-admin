...
import { API_URL, FORM_TEXTAREA_CLS, getApiErrorMessage, SECTION_LABEL_CLS } from '@/shared/lib'
import { Button, ImageDropZone } from '@/shared/ui'
import { useCreateNewsMutation, useUpdateNewsMutation } from '../api/newsApi'
import { type NewsContentValues, newsContentSchema } from '../types/schema'
