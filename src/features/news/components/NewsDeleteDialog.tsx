...
import { useDeleteNewsMutation } from '../api/newsApi'
...
export const NewsDeleteDialog = ({ id, title, onCancel }: IProps) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/45 backdrop-blur-sm">
      <div className="w-full max-w-100 rounded-2xl p-6 shadow-modal bg-white dark:bg-ink-900 border border-stone-200/70 dark:border-white/8">
