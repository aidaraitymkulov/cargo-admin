...
import { formatPhoneInput } from '@/shared/lib/utils'
import {
  Button,
  Dropdown,
  Form,
...
import { useCreateManagerMutation } from '../api/managersApi'
import { type CreateManagerFormValues, createManagerSchema } from '../types/schema'
