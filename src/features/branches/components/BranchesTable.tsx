    ...
    <>
      {data && data.length > 0 && (
        <div className="flex justify-end mb-4">
          <Button variant="forest" className="rounded-xl" onClick={openCreate}>
      ...
      >
        {isLoading ? (
          ...
          <div className="flex flex-col items-center justify-center py-24 gap-4">
            ...
            <Button variant="forest" className="rounded-xl mt-1" onClick={openCreate}>
              <Plus size={15} strokeWidth={2.5} />
              Добавить филиал
            </Button>
          </div>
      ...
      {formOpen && <BranchCreateForm onClose={closeForm} onCreated={openOnMap} />}
    </>
  )
}
